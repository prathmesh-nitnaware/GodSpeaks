...
const ProductCard = ({ product }) => {
  ...
  const { _id, name, images = ["/placeholder.jpg"], price, verse = "Bible Verse", rating = 5, sizes = [] } = product || {};
  ...
  const handleAddToCart = () => {
    // --- FIX: Don't hardcode 'M'. Use first available size or default to 'S' ---
    const defaultSize = sizes && sizes.length > 0 ? sizes[0] : 'S';
